...
from FL_server.utils import read_data
import matplotlib
matplotlib.use('Agg')
...
if __name__ == '__main__':
    ...
    algorithms_list = ['fedproxrandom','fedproxfedcs']
    lamb_value = [1, 1]
    learning_rate = [0.01,0.01]
    hyper_learning_rate = [0.2,0.2]
    local_ep = [20, 20]
    batch_size = [20,20]
    DATA_SET = "femnist"
    number_users = 20
    ...
    plot_summary_mnist(num_users=number_users, loc_ep1=local_ep, Numb_Glob_Iters=600, lamb=lamb_value,
