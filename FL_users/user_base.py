...
class Client(object):
    ...
    def solve_grad(self):
        ...
        print('Num sample:',self.num_samples)
    ...
    def solve_inner(self, optimizer, num_epochs=1, batch_size=10):
        ...
        bytes_w = self.model.size
        #print(bytes_w)
        soln, grad, comp = self.model.solve_inner(optimizer,self.train_data, num_epochs, batch_size) 
        bytes_r = self.model.size
        #print('ID :',self.id, 'Num sample:',self.num_samples)#,'comp', comp)#, 'Recieved Bytes:', bytes_r, 'send bytes',bytes_w)
        #print('Client Flops:',self.model.FlopsD())
        #print(bytes_w)
    ...
    def train_error_and_loss(self):
        ...
        #print('Num sample:',self.num_samples,'Client Loss:', loss,'Client Accuracy:', tot_correct*1.0/self.num_samples)
